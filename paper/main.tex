...
factor~$\delta$ is comparably high we do not report the opening move \(y\)).
...
We further explore the effects of the benefit and the strength of
selection on the generosity \(q\) and on the cooperation rate
...
last two rounds with two members of the population. We perform numerical
simulations for each of the fitness methods. In
...
dilemma, the donation game. We showed
