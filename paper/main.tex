...
According to this literature, individuals should naturally learn to adopt conditionally cooperative strategies if they expect to have further encounters with their interaction partner. 
While models of reciprocity have shaped our understanding of cooperation, they often make idealized assumptions on how individuals remember and process information. 
For example, when strategies change through social learning, it is commonly assumed that individuals take into account the strategy's average payoff.  
However, this would require them to compute (or remember) their payoffs against all other population members.
