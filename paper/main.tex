...
% The framework of evolutionary game theory has been applied in explaining the
...
% airwise comparison process is a stochastic process for modelling the evolution
...
% \begin{figure}[!htbp]
%   \centering
%   \includegraphics[width=\textwidth]{static/cooperation_rates_expected_and_stochastic_for_donation_game.pdf}
% \end{figure}
...
% \begin{figure}[!htbp]
%   \centering
%     \includegraphics[width=\textwidth]{static/more_memory_summary_results}
% \caption{{\bf The evolution of cooperation for different selection strength values.}
% We vary the selection strength $\beta$. In all cases, stochastic payoff
% evaluation tends to reduce the evolving cooperation rates. ({\bf A}) the
% probabilities \(p, q\) for resident population over \(10^7\) time steps for each
